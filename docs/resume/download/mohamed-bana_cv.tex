...
\usepackage{fontspec}
% \setmainfont{Iosevka}
\setmainfont[Scale=0.1,Mapping=tex-text,Ligatures={Common,Rare,TeX},Scale=MatchLowercase,Numbers=OldStyle]{Iosevka}
\setmonofont[Scale=0.1,Mapping=tex-text,Ligatures={Common,Rare,TeX},Scale=MatchLowercase,Numbers=OldStyle]{Iosevka}
...
% \author{I am \textbf{\emph{only}} looking for a fully remote Golang -Senior Software Engineer - role.}
\date{}
